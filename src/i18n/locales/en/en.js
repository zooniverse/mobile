export default {
  ...
  classifier: {
    ...
    workflowAssignmentDialog: {
      promotionMessage:
        "Congratulations! You've unlocked the next workflow. If you prefer to stay on this workflow, you can choose to stay.",
    ...
    interventions: {
      ...
      studyInfo:
        'I do not want to take part in this messaging [study](+tab+https://docs.google.com/document/d/1gLyN6Dgff8dOCOC88f47OD6TtFrfSJltsLgJMKkYMso/preview).',
    },
  },
  projects: {
    welcome: {
  ...
  project: {
    ...
    home: {
      ...
      talk: {
        ...
        other:
          '**%(count)s** people are talking about **%(title)s** right now.',
      },
      joinIn: 'Join in',
  ...
  organization: {
    ...
    notPermission:
      "If you're sure the URL is correct, you might not have permission to view this organization.",
  ...
  privacy: {
    ...
    youthPolicy: {
      title:
        'Advice for Volunteers Under 16 Years Old and Their Parent/Guardian',
      content:
  ...
  signIn: {
    ...
    whyHaveAccount:
      'Signed-in volunteers can keep track of their work and will be credited in any resulting publications.',
    signIn: 'Sign in',
    register: 'Register',
  ...
  resetPassword: {
    ...
    newPasswordFormDialog:
      'Enter the same password twice so you can get back to doing some research. Passwords need to be at least 8 characters long.',
    newPasswordFormLabel: 'New password:',
    newPasswordConfirmationLabel: 'Repeat your password to confirm:',
    enterEmailLabel:
      'Please enter your email address here and we’ll send you a link you can follow to reset it.',
    emailSuccess:
    ...
    loggedInDialog:
      'You are currently logged in. Please log out if you would like to reset your password.',
    missingEmailsSpamNote:
      'Please check your spam folder if you have not received the reset email.',
    missingEmailsAlternateNote:
      'If you have still not received an email, please try any other email address you may have signed up with.',
  },
  workflowToggle: {
    label: 'Active',
  },
  ...
  emailSettings: {
    ...
    general: {
      ...
      emailUnverifiedSuccess:
        'Confirmation email requested, please check your inbox',
  ...
  lab: {
    help: {
      howToBuildProject: {
        ...
        overview: {
          quickGuide:
            '* [A quick guide to building a project](#a-quick-guide-to-building-a-project)',
          navigating:
          ...
          inDetail: {
            ...
            linking:
              '* [Linking the Workflow Together](#linking-the-workflow-together)',
        ...
        quickGuide: {
          ...
          step10:
            '10. Guidelines on how to design your project to maximize engagement and data quality are provided on the [Policies page](https://help.zooniverse.org/getting-started/lab-policies).',
          step11:
        ...
        navigatingTheProjectBuilder: {
          ...
          glossaryPage:
            'For more Zooniverse definitions, check out the [Glossary page](https://help.zooniverse.org/getting-started/glossary).',
        },
        project: {
          title: '### Project',
          intro:
        ...
        projectDetails: {
          ...
          externalLinks:
            '* **External links:** Adding an external link will populate an entry in a list of links in the bottom right section of the project landing page.  These links open in a new tab when clicked. You can rearrange the displayed order by clicking and dragging on the left gray tab next to each link.',
          socialLinks:
            '* **Social links:** A specialized form of an external link, adding a social link will populate an entry in the list of links in the bottom right section of the project landing page that includes service-specific icons. You can rearrange the displayed order by clicking and dragging on the left gray tab next to each link, but all social links follow after external links in the displayed list.',
        },
        about: {
          title: '### About',
          intro:
        ...
        workflowDetails: {
          ...
          mainText:
            '* **Main Text:** Describe the task, or ask the question, in a way that is clear to a non-expert. Markdown can be used only to add images (with alt text), bold and italic text.',
          helpText:
  ...
  userSettings: {
    account: {
      ...
      displayNameHelp:
        'How your name will appear to other users in Talk and on your Profile Page',
      realName: 'Real name (optional)',
      realNameHelp:
        'Public; we’ll use this to give acknowledgement in papers, on posters, etc.',
      interventions: 'Show project intervention notifications.',
      interventionsHelp:
        'Allow projects to display messages while you are classifying.',
    ...
    profile: {
      ...
      profileHeaderImageHelp:
        'Drop an image here (any dimensions, less than %(size)s KB)',
