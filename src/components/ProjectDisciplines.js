...
const mapStateToProps = state => {
    ...
    return {
        ...
        hasBetaProjects,
        hasRecentProjects:
            state.user.projects && !R.isEmpty(state.user.projects),
...
function ProjectDisciplines({...props}) {
    ...
    function refreshProjects() {
        ...
        setRefreshing(true);
        fetchProjectPromise = makeCancelable(
            props.projectActions.fetchProjects(),
        );
    ...
    const disciplineInProjectList = discipline => {
        ...
        const isForLoggedInUser =
            !user.isGuestUser &&
            loggedInDisciplineTags(
                hasRecentProjects,
                hasPreviewProjects,
            ).includes(discipline.value);
        const isTagged =
