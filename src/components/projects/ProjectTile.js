...
const mapDispatchToProps = (dispatch, ownProps) => ({
  navigateToClassifier: navigateToClassifier(
    dispatch,
...
class ProjectTile extends Component {
  ...
  _overlayBanner() {
    const bannerStyle = this.props.inPreviewMode
      ? [styles.bannerContainer, styles.testBannerStyle]
  ...
  _workFlowList = () => {
    ...
    const workflowsView = R.addIndex(R.map)((workflow, index) => {
      const shouldShowBanner =
        projectDisplay.isComplete(workflow.completeness) &&
    ...
    return <View style={styles.cellsContainer}>{workflowsView}</View>;
  };
        ...
        <TouchableOpacity onPress={this._onMainViewPress}>
          <View style={styles.contentContainer}>
            ...
            <View style={styles.bannerOverlay}>
              {shouldDisplayIsOutOfData || this.props.inPreviewMode
                ? this._overlayBanner()
                : null}
            </View>
          </View>
