...
import {AnswerButton, SubmitButton, GuideButton} from './ClassifierButton';
...
class MultiAnswerClassifier extends Component {
    ...
    submitClassification() {
        return () => {
            const {classifierActions, subject} = this.props;
            const workflow = this.props.route.params.workflow;
            const {id, first_task} = workflow;
            const {answersSelected, imageDimensions} = this.state;
    ...
    render() {
        ...
        const {workflow, project, inBetaMode} =
                            ...
                            {answers.map((answer, index) => (
                                <View
                                    ...
                                    <AnswerButton
                                        ...
                                        selected={answersSelected.includes(
                                            index,
                                        )}
                                        text={answer.label}
