    ...
    (dispatch, inPreviewMode, inBetaMode, project, navigation, workflow) => {
        ...
        switch (workflow.type) {
            ...
            case 'single':
                ...
                break;
            case 'multiple':
                navigateToMultiAnswerClassifier(
                    inPreviewMode,
                    inBetaMode,
                    project,
                    workflow,
...
function navigateToSwipeClassifier(
    inPreviewMode,
    inBetaMode,
    project,
    workflow,
...
function navigateToQuestionClassifier(
    inPreviewMode,
    inBetaMode,
    project,
    workflow,
...
function navigateToMultiAnswerClassifier(
    inPreviewMode,
    inBetaMode,
    project,
    workflow,
...
function navigateToDrawingClassifier(
    inPreviewMode,
    inBetaMode,
    project,
    workflow,
